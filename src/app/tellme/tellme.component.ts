...
export class TellmeComponent {
  ...
  constructor(private router: Router, private _snackBar: MatSnackBar, private service: UserService, public http:HttpClient,private changeDetectorRef: ChangeDetectorRef) { }
  ngOnInit(): void {
